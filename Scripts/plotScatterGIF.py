...
for f in files:
    ...
    beams.append(os.path.basename(f)[4])
    if GenerateJS:
...
if UseLogo:
    ...
    fig.figimage(logo, 3 * fig.bbox.xmax + 60, 2 * fig.bbox.ymax - 150,       \
                 zorder=1)
